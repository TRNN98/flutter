...
import 'package:udtscc/FollowMe/pages/welfare/welfare_detail.dart';
...
class WelfareState extends State<Welfare> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CustomUI.appbarUi(Language.welfareLg('welfare', widget.param.lgs),
            ...
            child: SafeArea(
              child: Column(
                children: <Widget>[
                  ...
                  CustomUI.appbarDetailUi('assets/imgs/welfare.png', context),
                  lineSizedBox(context, -15),
                  Padding(
