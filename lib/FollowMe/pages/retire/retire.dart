...
import 'package:udtscc/FollowMe/pages/retire/retire_detail.dart';
...
class Retire extends StatefulWidget {
  ...
  const Retire(this.param, {super.key});

  @override
  RetireState createState() => RetireState();
...
class RetireState extends State<Retire> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CustomUI.appbarUi(Language.retireLg('retire', widget.param.lgs),
            ...
            child: SafeArea(
              child: Column(
                children: <Widget>[
                  ...
                  CustomUI.appbarDetailUi('assets/imgs/retire.png', context),
                  lineSizedBox(context, -15),
                  Padding(
                  ...
                  Expanded(
                    child: Padding(
                      padding: EdgeInsets.only(
                          left: paddinglist(context, 0),
                          right: paddinglist(context, 0)),
                      child: FutureBuilder<List<RetireModel>>(
                        future: Network.fetchRetire(
                            objDep, widget.param.token, context),
                        builder: (context, snapshot) {
                          if (snapshot.hasData) {
                            return snapshot.data!.isNotEmpty
                                ? _detail(retire: snapshot.data)
  ...
  Widget _detail({retire}) => Container(
              ...
              return InkWell(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => RetireDetail(
                          data: '[${jsonEncode(retire[index])}]',
                          param: widget.param),
                    ),
                  );
                },
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          Padding(
                            ...
                            child: Text(
                              MyClass.checkNull(
                                  retire[index].yearReceive.toString()),
                              textScaleFactor:
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          Padding(
                            ...
                            child: Text(
                              MyClass.checkNull(
                                  retire[index].retireDes.toString()),
                              textScaleFactor:
                                  MyClass.blocFontSizeApp(_fontsizeapps),
                              style:
                                  CustomTextStyle.dataHTxt(context, 0, 'BlH'),
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          Padding(
                            ...
                            child: Text(
                              MyClass.checkNull(
                                  retire[index].shareStock.toString()),
                              textScaleFactor:
                                  MyClass.blocFontSizeApp(_fontsizeapps),
                              style:
                                  CustomTextStyle.dataHTxt(context, 0, 'BlH'),
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          Padding(
                            ...
                            child: Text(
                              MyClass.checkNull(
                                  retire[index].buyShare.toString()),
                              textScaleFactor:
                                  MyClass.blocFontSizeApp(_fontsizeapps),
                              style:
                                  CustomTextStyle.dataHTxt(context, 0, 'BlH'),
    ...
    child: Row(
      ...
      children: <Widget>[
        Expanded(
          flex: 1,
          child: Text(
            Language.retireLg('yearReceive', lgs),
        ...
        Expanded(
          flex: 2,
          child: Text(
            Language.retireLg('retireDes', lgs),
            textAlign: TextAlign.center,
            textScaleFactor: MyClass.blocFontSizeApp(_fontsizeapps),
            style: CustomTextStyle.headTitleTxt(context, -1),
          ),
        ...
        Expanded(
          flex: 2,
          child: Text(
            Language.retireLg('shareStock', lgs),
            textAlign: TextAlign.center,
            textScaleFactor: MyClass.blocFontSizeApp(_fontsizeapps),
            style: CustomTextStyle.headTitleTxt(context, -1),
          ),
        ...
        Expanded(
          flex: 2,
          child: Text(
            Language.retireLg('buyShare', lgs),
            textAlign: TextAlign.center,
            textScaleFactor: MyClass.blocFontSizeApp(_fontsizeapps),
            style: CustomTextStyle.headTitleTxt(context, -1),
          ),
